       ...
       if($_GET['action'] == 'update'){
          if($_SERVER['REQUEST_METHOD'] == 'POST'){
              ...
              if(empty($Errors)){
                  ...
                  if($checker == 0){
                  update4Record('username', 'admin_first_name', 'admin_last_name', 'pass', $username, $firstName, $lastName, $pass, 'admin', 'admin_id', $Id);
                    echo "<script>window.setTimeout(function() {window.location.href = '?page=admin&request=update&id=$Id';}, 700)</script>";
                  }else{
           ...
           redirctErrorUrl('?page=admin', 'There is Something wrong.', 2);
       }
   } 
